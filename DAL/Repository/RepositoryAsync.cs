...
namespace DAL.Repository
{
    ...
    public class RepositoryAsync<TEntity> : IRepositoryAsync<TEntity> where TEntity : class
    {
        ...
        protected ArchiveDbContext _dbContext => _dbContextFactory?.DbContext;
        ...
        public ArchiveDbContext DbContextCMC()
        {
            return _dbContext;
        }
        ...
        ////////////////////////////////////:
        public virtual async Task<TEntity> GetByIdAsync(params object[] keyValues) => await _dbSet.FindAsync(keyValues);
